...
using Aula03_Exemplo4.Database;
using Microsoft.AspNetCore.Mvc;
using Aula03_Exemplo4.Models;
using Microsoft.EntityFrameworkCore;

namespace Aula03_Exemplo4.Controller
{
    [ApiController]
    [Route("[controller]")]
    public class MaquinaController : ControllerBase
    {
        ...
        // [HttpGet("{id}")]
        // public async Task<IEnumerable<Maquinas>> GetById(int id) // Retorna uma lista de usuários
        // {
        //     // await é uma palavra chave que só pode ser usada em métodos que são marcados com async
        //     return await _context.Maquinas.ToListAsync(); // Retorna todos os usuários do banco de dados
        // }
